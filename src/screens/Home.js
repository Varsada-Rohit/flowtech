         ...
         <div className='container mt-2'>
            ...
            >
               <motion.div
                  ...
                  className='col-lg-4 col-11 text-center'
               >
                  <CategoryCard
               ...
               >
                  <CategoryCard
                     CardInView={CardInView}
                     url={imagecat3}
                     name='Flush valve and Accessories'
                  />
               </motion.div>
            </motion.div>
         </div>
            ...
            <div className='row' style={{ margin: '5rem 0' }}>
               ...
               >
                  ...
                  >
                     ...
                     performance products to global customers by pursuing spirit
                     of innovation followed by Flowtech, as well as an R&D
                     center furnished with top notch research and development
                     equipments
                  </motion.div>
               </div>
            </div>
